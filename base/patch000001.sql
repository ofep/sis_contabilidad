...
/***********************************I-SCP-RCM-CONTA-0-29/08/2019****************************************/
ALTER TABLE conta.tcuenta
  DROP CONSTRAINT chk_tcuenta__tipo_cuenta RESTRICT;

ALTER TABLE conta.tcuenta
  ADD CONSTRAINT chk_tcuenta__tipo_cuenta CHECK ((tipo_cuenta)::text = ANY (ARRAY[('activo'::character varying)::text, ('pasivo'::character varying)::text, ('patrimonio'::character varying)::text, ('ingreso'::character varying)::text, ('gasto'::character varying)::text, ('orden'::character varying)::text]));
  /***********************************F-SCP-RCM-CONTA-0-29/08/2019****************************************/